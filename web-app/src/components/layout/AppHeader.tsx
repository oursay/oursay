...
export function AppHeader({
  ...
  return (
    <header className="grid grid-cols-[auto_1fr_auto] items-center gap-2 px-3 pb-3 pt-2">
      {onFilterClick ? (
        <button
          type="button"
          ...
          className={`inline-flex size-10 items-center justify-center rounded-full border border-border-strong bg-surface shadow-sm hover:bg-surface-muted ${filterActive ? "text-brand-600" : "text-ink"}`}
        >
      ...
      <button
        ...
        className="mx-auto inline-flex min-h-9 max-w-full items-center gap-1.5 rounded-full border border-border-strong bg-surface px-3 text-sm font-medium text-ink shadow-sm hover:bg-surface-muted"
      >
