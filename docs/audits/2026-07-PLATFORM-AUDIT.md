...
- **[Low · Implemented] `sponsorship`, waitlist, `verification_not_completed` state machine (`docs/01` §5.6–5.7) is spec-only** in the reviewed code paths. Not a security risk; note the gap.
