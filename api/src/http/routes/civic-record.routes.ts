  ...
  app.post(
    "/v1/civic/appends/submit",
    {
      ...
      schema: {
        ...
        response: {
          201: refSchema,
          400: { description: "Envelope / binding / content validation failed", ...errorSchema },
          401: { description: "Missing or invalid session", ...errorSchema },
          403: { description: "Persona/signer ownership or act-gate denied", ...errorSchema },
          409: { description: "txId already exists on the public record", ...errorSchema },
          503: { description: "Public-record ledger unavailable (pool gate fail-closed)", ...errorSchema },
        },
      },
    },
    async (req, reply) => {
